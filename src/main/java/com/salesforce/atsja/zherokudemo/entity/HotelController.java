...
public class HotelController implements Serializable {
    ...
    private HotelJpaController jpaController = null;
    ...
    private HotelJpaController getJpaController() {
        if (jpaController == null) {
            jpaController = new HotelJpaController(Persistence.createEntityManagerFactory("com.salesforce.atsja_zHerokuDemo_war_1.0PU"));
        }
        ...
        if (pagination == null) {
            pagination = new PaginationHelper(10) {
                ...
                public int getItemsCount() {
                    return getJpaController().getHotelCount();
                }

                @Override
                public DataModel createPageDataModel() {
                    return new ListDataModel(getJpaController().findHotelEntities(getPageSize(), getPageFirstItem()));
                }
            };
        }
        return pagination;
    ...
    private void performDestroy() {
        try {
            getJpaController().destroy(current.getHotelid());
    ...
    private void updateCurrentItem() {
        int count = getJpaController().getHotelCount();
        ...
        if (selectedItemIndex >= 0) {
            current = getJpaController().findHotelEntities(1, selectedItemIndex).get(0);
        }
    }
    ...
    public SelectItem[] getItemsAvailableSelectMany() {
        return JsfUtil.getSelectItems(getJpaController().findHotelEntities(), false);
    }

    public SelectItem[] getItemsAvailableSelectOne() {
        return JsfUtil.getSelectItems(getJpaController().findHotelEntities(), true);
    }
    ...
    public static class HotelControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            return controller.getJpaController().findHotel(getKey(value));
        }
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Hotel) {
                ...
                return getStringKey(o.getHotelid());
            } else {
